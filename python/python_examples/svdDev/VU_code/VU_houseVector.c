...
vsip_vview_f *houseVector_f(vsip_vview_f* x){
...
vsip_cvview_f *chouseVector_f(vsip_cvview_f* x){
...
vsip_vview_d *houseVector_d(vsip_vview_d* x){
...
vsip_cvview_d* chouseVector_d(vsip_cvview_d* x){
