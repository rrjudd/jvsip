...
gcc-4.2 -bundle -arch x86_64 -isysroot /Developer-old/SDKs/MacOSX10.6.sdk /Library/Frameworks/jvsipF.framework/jvsipF /Library/Frameworks/Python.framework/Versions/2.7/lib/libpython2.7.dylib *.o -o _svdUtils.so
