...
void vsip_gemp_f(vsip_scalar_f alpha,
   ...
   }
   {
       ...
       vsip_scalar_f *ap0 = ap,
                     ...
                     *rp0 = rp;
       switch(method){
          case 0 : VI_GEMP_jki_F; break; /* ccc */
          case 1 : VI_GEMP_ikj_F; break; /* ccr */ 
          case 2 : VI_GEMP_jki_F; break; /* crc */
          case 3 : VI_GEMP_ikj_F; break; /* crr */            
          case 4 : VI_GEMP_ijk_F; break; /* rcc */
          case 5 : VI_GEMP_ijk_F; break; /* rcr */
          case 6 : VI_GEMP_ikj_F; break; /* rrc */
          case 7 : VI_GEMP_ikj_F;        /* rrr */
      }
   }
}
