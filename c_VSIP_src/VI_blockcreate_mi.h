...
**********************************************************************/
/* $Id: VI_blockcreate_mi.h,v 2.1 2006/06/08 22:19:26 judd Exp $ */

#include<vsip.h>
#include<vsip_blockattributes_mi.h>

#ifndef VI_BLOCKCREATE_MI_H
#define VI_BLOCKCREATE_MI_H
...
VI_blockcreate_mi(
  ...
  vsip_memory_hint h) {
   ...
   if(b != NULL){
      b->array = (vsip_scalar_vi*)malloc(2 * N * sizeof(vsip_scalar_vi));
      if(NULL == b->array){
         free((void*)b);
         b = (vsip_block_mi*) NULL;
      } else {
