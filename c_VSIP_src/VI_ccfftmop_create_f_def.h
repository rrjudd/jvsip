...
**********************************************************************/
/* $Id: VI_ccfftmop_create_f_def.h,v 2.1 2003/04/22 02:19:56 judd Exp $ */
#include"VI_nuV.h"
#include"VI_jofk.h"
                       ...
                       vsip_alg_hint hint)
{
    ...
    /* create a space to copy too when unsorting */
    fft->temp = vsip_cvcreate_f(fft->MN,VSIP_MEM_NONE); 
