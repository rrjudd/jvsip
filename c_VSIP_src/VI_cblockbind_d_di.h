...
**********************************************************************/
/* $Id: VI_cblockbind_d_di.h,v 2.0 2003/02/22 15:18:28 judd Exp $ */
/* VI_cblockbind_d default interleaved */
...
if(b != (vsip_cblock_d*)NULL){
   ...
   b->bindings = 0;
   if(Ip == (vsip_scalar_d*)NULL){ /* interleaved */
      b->cstride = 2;
      b->R = vsip_blockbind_d(Rp,N,h);
      b->I = (vsip_block_d*)malloc(sizeof(vsip_block_d));
      if((b->R == (vsip_block_d*)NULL) || 
         (b->I == (vsip_block_d*)NULL)){ /* fail; cleanup and exit */
         free((void *)b->R); 
         free((void *)b->I);
         free((void *)b);
