...
**********************************************************************/
/* $Id: vsip_cmlog_f.c,v 2.0 2003/02/22 15:18:43 judd Exp $ */
       ...
       while(n_mn-- > 0){
          ...
          while(n-- >0){
             ...
             if(s == 0){
                 ...
                 mag = (vsip_scalar_f)log(s * sqrt((*rp_r * *rp_r)/ss + (*rp_i * *rp_i)/ss));
             }
             *rp_i = (vsip_scalar_f)atan2(*rp_i,*rp_r);
             *rp_r = mag;
             rp_r += rst_mj;
             rp_i += rst_mj;
          }
          ...
          while(n-- >0){
             ...
             if(s == 0){
               *rp_r = -VSIP_MAX_SCALAR_F; /* error */
                ...
                *rp_r = (vsip_scalar_f)log(s * sqrt((*ap_r * *ap_r)/ss + (*ap_i * *ap_i)/ss));
             }
             *rp_i  = (vsip_scalar_f)atan2(*ap_i,*ap_r);
