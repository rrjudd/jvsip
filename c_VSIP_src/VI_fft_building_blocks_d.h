...
**********************************************************************/
/* $Id: VI_fft_building_blocks_d.h,v 2.7 2009/12/27 03:11:48 judd Exp $ */
#ifndef VI_FFT_BUILDING_BLOCKS_D_H
#define VI_FFT_BUILDING_BLOCKS_D_H 1

/* constants */
#define C3PC  ((vsip_scalar_d)-1.50 ) /* -(1+cos(2pi/3) */
#define C3PS  ((vsip_scalar_d)+0.86602540378443864676372317075293618347140262690519) /* sin(2pi/3) or sqrt(3)/2 */

#define C5c1 ((vsip_scalar_d)-1.250) /* (cos(2 * pi/5) + cos(4*pi/5))/2 -1 */
#define C5c2 ((vsip_scalar_d)+0.55901699437494742410229341718281905886015458990288) /* (cos(2 * pi/5) - cos(4*pi/5))/2 */
#define C5c3 ((vsip_scalar_d)+0.58778525229247312916870595463907276859765243764315) /* sin(4 * pi/5) */
#define C5c4 ((vsip_scalar_d)+1.5388417685876267012851452880184549120033510717689) /* sin(2 * pi/5) + sin(4 * pi/5) */
#define C5c5 ((vsip_scalar_d)+0.36327126400268044294773337874030937480804619648261) /* sin(2*pi/5) - sin(4*pi/5) */

#define C7c1 ((vsip_scalar_d)-1.16666666666666666666666666666666666666666666666667) /*C7c1=-1 + (cos(2 * pi/7) + cos(4 * pi/7) + cos(6 * pi/7))/3*/
#define C7c2 ((vsip_scalar_d)+0.79015646852540019719167155067090647729894139756307) /*C7c2=(2 * cos(2 * pi/7) - cos(4 * pi/7) - cos(6 * pi/7))/3*/
#define C7c3 ((vsip_scalar_d)+0.055854267289647737622235897830128092799688902097878) /*C7c3=(cos(2 * pi/7) - 2 * cos(4 * pi/7) + cos(6 * pi/7))/3*/
#define C7c4 ((vsip_scalar_d)+0.73430220123575245956943565284077838449925249546519) /*C7c4=(cos(2 * pi/7) + cos(4 * pi/7) - 2 * cos(6 * pi/7))/3*/
#define C7c5 ((vsip_scalar_d)+0.440958551844098431750269292273210070951709863847085) /*C7c5=((sin(2 * pi/7) + sin(4 * pi/7) - sin(6 * pi/7))/3) */
#define C7c6 ((vsip_scalar_d)+0.34087293062393137695817523440084767928062465486161) /*C7c6=(2 * sin(2 * pi/7) - sin(4 * pi/7) + sin(6 * pi/7))/3*/
#define C7c7 ((vsip_scalar_d)-0.53396936033772517526786239072072114628107593677292) /*C7c7=( sin(2 * pi/7) - 2 * sin(4 * pi/7) - sin(6 * pi/7))/3*/
#define C7c8 ((vsip_scalar_d)+0.87484229096165655222603762512156882556170059163453) /*C7c8=( sin(2 * pi/7) + sin(4 * pi/7) + 2 * sin(6 * pi/7))/3*/

#define C8c1 ((vsip_scalar_d)+0.70710678118654752440084436210484903928483593768847) /*cos(pi/4)*/
...
VI_dft_d(void *tfft) {
  ...
  c->length = N;
  for(j=0; j<N; j++){
    register vsip_scalar_d t_r=0;
    register vsip_scalar_d t_i=0;
    apr = aprp; api = apip;
    t_r += (*apr * *bpr - *api * *bpi);
    t_i += (*api * *bpr + *apr * *bpi);
    k = 0;
