...
void (vsip_cmvprod4_d)(
  ...
  const vsip_cvview_d* r) {
     ...
     vsip_scalar_d  *bp0_r  = b->block->R->array + b->offset * b->block->cstride,
                    *rp0_r  = r->block->R->array + r->offset * r->block->cstride,
                    *Ap00_r = A->block->R->array + A->offset * A->block->cstride;
     vsip_scalar_d  *bp0_i  = b->block->I->array + b->offset * b->block->cstride,
     ...
     vsip_cscalar_d a00, a01, a02, a03;
     vsip_cscalar_d a10, a11, a12, a13;
     vsip_cscalar_d a20, a21, a22, a23;
     vsip_cscalar_d a30, a31, a32, a33;

     vsip_scalar_d *Ap10_r = Ap00_r + ACst, *bp1_r = bp0_r + bst, *rp1_r = rp0_r + rst;
     vsip_scalar_d *Ap20_r = Ap10_r + ACst, *bp2_r = bp1_r + bst, *rp2_r = rp1_r + rst;
     vsip_scalar_d *Ap30_r = Ap20_r + ACst, *bp3_r = bp2_r + bst, *rp3_r = rp2_r + rst;

     vsip_scalar_d *Ap10_i = Ap00_i + ACst, *bp1_i = bp0_i + bst, *rp1_i = rp0_i + rst;
     vsip_scalar_d *Ap20_i = Ap10_i + ACst, *bp2_i = bp1_i + bst, *rp2_i = rp1_i + rst;
     vsip_scalar_d *Ap30_i = Ap20_i + ACst, *bp3_i = bp2_i + bst, *rp3_i = rp2_i + rst;
