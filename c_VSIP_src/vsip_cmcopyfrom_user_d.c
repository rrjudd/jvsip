...
**********************************************************************/
/* $Id: vsip_cmcopyfrom_user_d.c,v 2.1 2007/04/18 17:15:17 judd Exp $ */

#include<vsip.h>
#include<vsip_cmviewattributes_d.h>

void (vsip_cmcopyfrom_user_d)(
  vsip_scalar_d* const re,
  vsip_scalar_d* const im,
  vsip_major major,
  const vsip_cmview_d* a) {
   ...
   vsip_scalar_d *aprow_r;
   vsip_scalar_d *apcol_r;
   vsip_scalar_d *aprow_i;
   vsip_scalar_d *apcol_i;
