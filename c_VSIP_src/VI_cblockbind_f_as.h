...
**********************************************************************/
/* $Id: VI_cblockbind_f_as.h,v 2.0 2003/02/22 15:18:28 judd Exp $ */
/* VI_cblockbind_f always split */

if(b != (vsip_cblock_f*)NULL){   
   b->r_data = (vsip_scalar_f*)malloc( N * sizeof(vsip_scalar_f));
   b->i_data = (vsip_scalar_f*)malloc( N * sizeof(vsip_scalar_f));
