...
**********************************************************************/
/* $Id: vsip_mvprod4_d.c,v 2.1 2006/04/27 01:58:00 judd Exp $ */
...
void (vsip_mvprod4_d)(
  ...
  const vsip_vview_d* r) {
     ...
     vsip_scalar_d b0,b1,b2,b3;

     vsip_scalar_d a00, a01, a02, a03;
     vsip_scalar_d a10, a11, a12, a13;
     vsip_scalar_d a20, a21, a22, a23;
     vsip_scalar_d a30, a31, a32, a33;

     vsip_scalar_d *Ap10 = Ap00 + ACst, *bp1 = bp0 + bst, *rp1 = rp0 + rst;
     vsip_scalar_d *Ap20 = Ap10 + ACst, *bp2 = bp1 + bst, *rp2 = rp1 + rst;
     vsip_scalar_d *Ap30 = Ap20 + ACst, *bp3 = bp2 + bst, *rp3 = rp2 + rst;
