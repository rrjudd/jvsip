...
**********************************************************************/
/* $Id: VI_blockcreate_vi.h,v 2.1 2006/06/08 22:19:26 judd Exp $ */

#include<vsip.h>
#include<vsip_blockattributes_vi.h>

#ifndef VI_BLOCKCREATE_VI_H
#define VI_BLOCKCREATE_VI_H
static
vsip_block_vi* 
VI_blockcreate_vi(
  size_t N, 
  ...
  if(b != NULL){
      b->array = (vsip_scalar_vi*)malloc(N * sizeof(vsip_scalar_vi));
      if(NULL == b->array){
         free((void*)b);
         b = (vsip_block_vi*)NULL;
      } else {
