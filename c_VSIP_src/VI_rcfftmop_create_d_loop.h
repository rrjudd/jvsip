...
**********************************************************************/
/* $Id: VI_rcfftmop_create_d_loop.h,v 2.0 2003/02/22 15:18:33 judd Exp $ */
/* real to complex fft */
#ifndef _VI_RCFFTMOP_CREATE_D_LOOP_H
#define _VI_RCFFTMOP_CREATE_D_LOOP_H
          ...
          vsip_alg_hint hint)
{
    ...
    fft = vsip_rcfftop_create_d(L,scale,ntimes,hint);
...
#endif /* _VI_RCFFTMOP_CREATE_D_LOOP_H */
