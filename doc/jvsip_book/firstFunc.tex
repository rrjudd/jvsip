\afuncT{first}{First. Starting at a user specified index find the index of the first selection operation for which the specified binary operation is true. See C VSIPL specification for more information.}{selectionOperations}
\\\cvsiplh
\afh
{
\ttfamily
