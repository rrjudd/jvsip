\subsubsection*{Matrix and Vector Operations\hspace*{\fill} \hyperlink{linearAlgebraFunctions}{(up)}} \addcontentsline{toc}{subsubsection}{Matrix and Vector Operations}
\begin{table}[H]
