\subsubsection*{Selection Operations\hspace*{\fill}\hyperlink{ElementwiseOperations}{(up)}\hypertarget{selectionOperations}{}}\addcontentsline{toc}{subsubsection}{Selection Operations}
...
\hlnkFunc{cmaxmgsq} & \parbox{.7\textwidth}{Maximum Magnitude Squared By-Element between complex \ttbf{view}s}\\
...
\hlnkFunc{cminmgsq} & \parbox{.7\textwidth}{Minimum Magnitude Squared By-Element between complex \ttbf{view}s}\\
\hlnkFunc{cminmgsqval} &\parbox{.7\textwidth}{Minimum Magnitude Squared Value of a complex \ttbf{view}}\\
