...
\subsection*{Summary of VSIPL Types}\addcontentsline{toc}{section}{Summary of VSIPL Types}
\subsection*{Support Functions}\addcontentsline{toc}{section}{Support Functions}
    \input{VSIP1p3SupportFunctions}
\subsubsection*{Initialization and Finalization Operations}
    \input{InitSupport}
    \input{BlockSupport}
    \input{VectorSupport}
    \input{TensorSupport}
