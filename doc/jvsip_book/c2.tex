...
\input{ceilFunc}\input{choldFunc}\input{convFunc}\input{corrFunc}
\input{cosFunc}\input{coshFunc}\input{ceilFunc}
\input{conjFunc}
\input{covsolFunc}
\input{cumsumFunc}\input{copyFunc}
\input{divFunc}\input{dotFunc}
\input{eulerFunc}\input{expFunc}\input{exp10Func}
\input{fftFunc}\input{firFunc}
\input{floorFunc}
\input{gempFunc}\input{gemsFunc}
\input{hermFunc}
\input{jdotFunc}\input{jprodFunc}
\input{kronFunc}
\input{llsqsolFunc}\input{ludFunc}
...
\input{negFunc}
\input{outerFunc}
\input{prod3Func}\input{prod4Func}\input{prodFunc}\input{prodtFunc}\input{prodhFunc}
\input{qrdFunc}
...
\input{sumsqvalFunc}
\input{svdFunc}
\input{tanFunc}\input{tanhFunc}\input{toepsolFunc}\input{transFunc}