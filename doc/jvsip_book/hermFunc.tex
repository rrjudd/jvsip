...
\\\cvsiplh
\\\hspace*{.06\textwidth}\parbox{.94\textwidth}{The output matrix must be created with the 
...
type to store\\*the output of the transpose and returns it.}
\item{The method is defined as a property since no arguments are required and is always\\*done out-of-place}
...
\item{This must be done out-of-place unless the matrix is square.}
}