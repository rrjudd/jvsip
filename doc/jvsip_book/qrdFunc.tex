...
%
%\newline \hspace*{.8cm} \vspace*{.1cm} \texttt{qrd\_create}
\newline \hspace*{1.cm} {
\ttfamily\vspace{.3cm}
\begin{tabular}[H]{|l|}
...
\hline\end{tabular}\\}
%
%\newline \hspace*{.8cm} \vspace*{.1cm} \texttt{qrd\_destroy}
\newline \hspace*{1.cm} {
\ttfamily\vspace{.3cm}
\begin{tabular}[H]{|l|}
...
\hline\end{tabular}\\}
%
%\newline \hspace*{.8cm} \vspace*{.1cm} \texttt{qrd}
\newline \hspace*{1.cm}{
\ttfamily\vspace{.3cm}
\begin{tabular}[H]{|l|}
\multicolumn{1}{c}{\rmfamily \bfseries Calculate LU Decomposition\vspace{.1cm}}\\ \hline
int vsip\_qrd\_d(vsip\_qr\_d*, const vsip\_mview\_d*);\\
int vsip\_qrd\_f(vsip\_qr\_f*, const vsip\_mview\_f*);\\
int vsip\_cqrd\_d(vsip\_cqr\_d*, const vsip\_cmview\_d*);\\
int vsip\_cqrd\_f(vsip\_cqr\_f*, const vsip\_cmview\_f*);\\
\hline\end{tabular}\\}
%
%\newline \hspace*{.8cm} \vspace*{.1cm} \texttt{qr}\\
\newline \hspace*{1.cm}{
\ttfamily\vspace{.3cm}
\begin{tabular}[H]{|l|}
\multicolumn{1}{c}{\rmfamily \bfseries Solve Using Calculated LU Decomposition\vspace{.1cm}}\\ \hline
int vsip\_qr\_d(const vsip\_qr\_d*, vsip\_mat\_op,\\*\hspace*{.8cm} const vsip\_mview\_d*);\\
int vsip\_qr\_f(const vsip\_qr\_f*, vsip\_mat\_op,\\*\hspace*{.8cm} const vsip\_mview\_f*);\\
int vsip\_cqr\_d(const vsip\_cqr\_d*, vsip\_mat\_op,\\*\hspace*{.8cm} const vsip\_cmview\_d*);\\
int vsip\_cqr\_f(const vsip\_cqr\_f*, vsip\_mat\_op,\\*\hspace*{.8cm} const vsip\_cmview\_f*);\\
\hline\end{tabular}\\}
%
%\newline \hspace*{.8cm} \vspace*{.1cm} \texttt{qrd\_getattr}
\newline \hspace*{1.cm}{
\ttfamily\vspace{.3cm}
\begin{tabular}[H]{|l|}
\multicolumn{1}{c}{\rmfamily \bfseries Fill LU Attribute Structure\vspace{.1cm}}\\ \hline
void vsip\_qrd\_getattr\_d(const vsip\_qr\_d*,\\*\hspace*{.8cm} vsip\_qr\_attr\_d*);\\
void vsip\_qrd\_getattr\_f(const vsip\_qr\_f*,\\*\hspace*{.8cm} vsip\_qr\_attr\_f*);\\
void vsip\_cqrd\_getattr\_d(const vsip\_cqr\_d*,\\*\hspace*{.8cm} vsip\_cqr\_attr\_d*);\\
void vsip\_cqrd\_getattr\_f(const vsip\_cqr\_f*,\\*\hspace*{.8cm} vsip\_cqr\_attr\_f*);\\
\hline\end{tabular}\\}
%
\clearpage\pyjvsiph
