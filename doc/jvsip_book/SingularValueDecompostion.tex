\subsubsection*{Singular Value Decomposition\hspace*{\fill} \hyperlink{linearAlgebraFunctions}{(up)}} \addcontentsline{toc}{subsubsection}{Singular Value Decomposition}
\begin{table}[H]
