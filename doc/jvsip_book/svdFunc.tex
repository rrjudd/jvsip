...
vsip\_sv\_d* vsip\_svd\_create\_d(vsip\_length);\\
vsip\_sv\_f* vsip\_svd\_create\_f(vsip\_length);\\
vsip\_csv\_d* vsip\_csvd\_create\_d(vsip\_length);\\
vsip\_csv\_f* vsip\_csvd\_create\_f(vsip\_length);\\
\hline\end{tabular}\\}
%
...
int vsip\_svd\_d(vsip\_sv\_d*, const vsip\_mview\_d*);\\
int vsip\_svd\_f(vsip\_sv\_f*, const vsip\_mview\_f*);\\
int vsip\_csvd\_d(vsip\_csv\_d*, const vsip\_cmview\_d*);\\
int vsip\_csvd\_f(vsip\_csv\_f*, const vsip\_cmview\_f*);\\
\hline\end{tabular}\\}
%
%\newline \hspace*{.8cm} \vspace*{.1cm} \texttt{sv}\\
\newline \hspace*{1.cm}{
\ttfamily\vspace{.3cm}
\begin{tabular}[H]{|l|}
\multicolumn{1}{c}{\rmfamily \bfseries Solve Using Calculated LU Decomposition\vspace{.1cm}}\\ \hline
int vsip\_sv\_d(const vsip\_sv\_d*, vsip\_mat\_op,\\*\hspace*{.8cm} const vsip\_mview\_d*);\\
int vsip\_sv\_f(const vsip\_sv\_f*, vsip\_mat\_op,\\*\hspace*{.8cm} const vsip\_mview\_f*);\\
int vsip\_csv\_d(const vsip\_csv\_d*, vsip\_mat\_op,\\*\hspace*{.8cm} const vsip\_cmview\_d*);\\
int vsip\_csv\_f(const vsip\_csv\_f*, vsip\_mat\_op,\\*\hspace*{.8cm} const vsip\_cmview\_f*);\\
\hline\end{tabular}\\}
%
