\subsubsection*{General Square Linear System Solver\hspace*{\fill} \hyperlink{linearAlgebraFunctions}{(up)}} \addcontentsline{toc}{subsubsection}{General Square Linear System Solver}
\begin{table}[H]
