...
\\\hspace*{.06\textwidth}\parbox{.93\textwidth}{\vspace*{.005\textheight}The \ttbf{sin} function works much the same as the C VSIPL version except that a convenience pointer to the output view is returned. This may be done in-place if \ttbf{in==out}.}
