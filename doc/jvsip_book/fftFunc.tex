...
\ttbf{alghint} & \parbox[t]{.70\textwidth}{Algorithm hint to optimize for speed, size, or accuracy (VSIP\_ALG\_TIME, VSIP\_ALG\_SPACE, VSIP\_ALG\_NOISE)\vspace*{.1cm}}\\
\hline \end{tabular}}
\\
