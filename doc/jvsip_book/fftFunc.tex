...
\hspace*{1.cm}\parbox{.75\textwidth}{Note \ttbf{arg} will contain some or all of the following in the order listed\\
...
\multicolumn{2}{|l|}{\parbox[t]{.9\textwidth}{\center{\rmfamily \bfseries Discrete Fourier Transform Class}\vspace{.2cm}}}\\ \hline \hline
'ccfftip\_f' & \parbox[t]{.75\textwidth}{Complex-to-complex FFT single precision float in-place \\*\ttbf{arg = (M,N,scl,dir,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'ccfftop\_f' & \parbox[t]{.75\textwidth}{Complex-to-complex FFT single precision float out-of-place \\*\ttbf{arg = (M,N,scl,dir,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'rcfftop\_f' & \parbox[t]{.75\textwidth}{Real-to-complex FFT single precision float out-of-place \\*\ttbf{arg = (M,N,scl,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'crfftop\_f'& \parbox[t]{.75\textwidth}{Complex-to-real FFT single precision out-of-place\\*\ttbf{arg = (M,N,scl,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'ccfftip\_d' & \parbox[t]{.75\textwidth}{Complex-to-complex FFT double precision in-place\\*\ttbf{arg = (M,N,scl,dir,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'ccfftop\_d'& \parbox[t]{.75\textwidth}{Complex-to-complex FFT double precision out-of-place\\*\ttbf{arg = (M,N,scl,dir,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'rcfftop\_d'& \parbox[t]{.75\textwidth}{Real-to-complex multiple FFT single precision out-of-place\\*\ttbf{arg = (M,N,scl,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'crfftop\_d'& \parbox[t]{.75\textwidth}{Complex-to-real multiple FFT single precision out-of-place\\*\ttbf{arg = (M,N,scl,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'ccfftmip\_f' & \parbox[t]{.75\textwidth}{Complex-to-complex multiple FFT single precision in-place\\*\ttbf{arg = (M,N,scl,dir,major,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'ccfftmop\_f' & \parbox[t]{.75\textwidth}{Complex-to-complex multiple FFT single precision out-of-place\\*\ttbf{arg = (M,N,scl,dir,major,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'rcfftmop\_f' & \parbox[t]{.75\textwidth}{Real-to-complex multiple FFT single precision out-of-place\\*\ttbf{arg = (M,N,scl,major,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'crfftmop\_f' &\parbox[t]{.75\textwidth}{ Complex-to-real multiple FFT single precision out-of-place\\*\ttbf{arg = (M,N,major,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'ccfftmip\_d' & \parbox[t]{.75\textwidth}{Complex-to-complex multiple FFT double precision in-place\\*\ttbf{arg =(M,N,scl,dir,major,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'ccfftmop\_d' & \parbox[t]{.75\textwidth}{Complex-to-complex multiple FFT double precision out-of-place\\*\ttbf{arg = (M,N,scl,dir,major,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'rcfftmop\_d' & \parbox[t]{.75\textwidth}{Real-to-complex multiple FFT double precision out-of-place\\*\ttbf{arg = (M,N,scl,major,ntimes,alghint)}\vspace*{.1cm}}\\\hline
'crfftmop\_d' & \parbox[t]{.75\textwidth}{Complex-to-real multiple FFT double precision out-of-place\\*\ttbf{arg = (M,N,scl,major,ntimes,alghint)}\vspace*{.1cm}}\\
\hline\end{tabular}
