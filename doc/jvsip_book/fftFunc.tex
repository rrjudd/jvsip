...
\hspace*{1.1cm}\textbf{Example: }Forward transform of vector \ttbf{x} in-place\\*
...
\hspace*{1.1cm}\textbf{Example: }real to complex and complex to real FFT\\*
\hspace*{1.5cm}\ttbf{ y=x.rcfft}\\*
\hspace*{1.5cm}\ttbf{ z=y.crfft}\\*
\hspace*{1.5cm}\ttbf{ y=x.ccfft}
\hspace*{1.5cm}\parbox{.85\textwidth}{}\\
\newline\hspace*{.8cm}{\textbf{FFT Methods}\\
To create an FFT object  
fftObj=FFT('type',*args)
Where \ttbf{args} is a tuple containing the create parameters for the FFT type selected.