...
\begin{comments}
\item{The \ttbf{atan2} function works much the same as the C VSIPL version except that a convenience pointer to the output view is returned. 
\item The \ttbf{atan2} function may be done in-place if \ttbf{inOne==out} or \ttbf{inTwo==out}.}
\end{comments}