...
\newcommand{\afuncT}[3]{\clearpage{\Large \textbf{\hypertarget{{\ttfamily \bfseries#1Func}}{#1}}{\hspace*{\fill}\hypertarget{#1Func}{}\hyperlink{#3}{up}}} \vspace{.01\textheight}\\ \hspace*{.02\textwidth} \parbox{.94\textwidth}{#2 } \vspace{.005\textheight}}
