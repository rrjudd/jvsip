...
\\ \hspace*{1.1cm}{\textbf{Available: }}#1\hspace{.25cm}{\textbf{Property: }} #2\hspace{.25cm}{\textbf{In-Place: }} #3 
\\ \hspace*{1.1cm}{\bfseries Example:} {\ttfamily #4}}}
%
\newcommand{\apyfunc}[2]{\newline \hspace*{.8cm} \textbf{Function} 
\\ \hspace*{1.1cm} \textbf{Available:} #1 
\\ \hspace*{1.1cm} \textbf{Example:} {\ttfamily #2}}
%use as \pyJvsip{}
