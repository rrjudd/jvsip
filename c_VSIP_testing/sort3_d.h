...
**********************************************************************/
/* $Id: sort3_d.h,v 1.1 2008/09/19 21:01:49 judd Exp $ */

static void sort3_d(void){
   printf("********\nTEST sort (3) for double\n");
   {
      ...
      vsip_vsortip_d(s, VSIP_SORT_BYMAGNITUDE, VSIP_SORT_DESCENDING,VSIP_TRUE, vi);
      vsip_vmag_d(s,s);
