...
**********************************************************************/
/* $Id: get_put_attrib_i.h,v 2.0 2003/02/22 15:23:33 judd Exp $ */
static void get_put_attrib_i(void){
   printf("********\nTEST get_put_attrib_i\n");
   {
       ...
       printf("test vputattrib_i\n"); fflush(stdout);
       {
          attr.offset = jvo; attr.stride = jvs; attr.length = jvl;
          vsip_vputattrib_i(v,&attr);
          vsip_vgetattrib_i(v,&attr);
...
/**************************************************************************/
       printf("test mgetattrib_i\n"); fflush(stdout);
       {
          vsip_mgetattrib_i(m,&mattr);
...
/**************************************************************************/
       printf("test tgetattrib_i\n"); fflush(stdout);
       {
          vsip_tgetattrib_i(t,&tattr);
