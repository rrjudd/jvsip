...
**********************************************************************/
/* $Id: mcos_d.h,v 2.0 2003/02/22 15:23:24 judd Exp $ */
static void mcos_d(void){
   printf("\n*******\nTEST mcos_d\n\n");
   { vsip_scalar_d data[] = {0, M_PI/4.0, M_PI/2.0, M_PI, 1.25 * M_PI, 1.5 * M_PI};
     vsip_scalar_d ans[] = {1.0000, 0.7071, 0.0000,-1.0000,-0.7071,0.0000};
