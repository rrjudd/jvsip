...
**********************************************************************/
/* $Id: sort_d.h,v 1.2 2008/09/19 12:48:30 judd Exp $ */

static void sort_d(void){
   printf("********\nTEST sort for double\n");
   {
      ...
      vsip_vsortip_d(s, VSIP_SORT_BYVALUE, VSIP_SORT_ASCENDING,VSIP_TRUE, vi);
