/* Created RJudd */
/* $Id: ccfftmip_d.h,v 1.1 2008/11/02 22:42:07 judd Exp $ */

static void ccfftmip_d(void)
{  
  printf("******\nTEST ccfftmip double forward\n");
  {
      vsip_length N = 1000;
      ...
      { /* 8 by 4 */
         ...
         fft = vsip_ccfftmip_create_d(8,4,1.0,VSIP_FFT_FWD,VSIP_ROW,0,VSIP_ALG_SPACE);
      ...
      { /* 8 by 4 */
         ...
         fft = vsip_ccfftmip_create_d(8,4,1.0,VSIP_FFT_FWD,VSIP_COL,0,VSIP_ALG_SPACE);
         A = vsip_cmbind_d(block,4,2,8,17,4);
         B = vsip_cmcreate_d(8,4,VSIP_ROW,VSIP_MEM_NONE);
         vsip_cmcopyfrom_user_d(rdta,idta,VSIP_ROW,A);
         vsip_cmcopyfrom_user_d(rdta0,idta0,VSIP_ROW,B);
     ...
     { /* 8 by 4 */
         ...
         vsip_scalar_d idta[32] = { 0.2769,   0.4387,   0.7094,   0.9597,
                                    ...
                                    0.9502,   0.4456,   0.1190,   0.5060,
                                    0.0344,   0.6463,   0.4984,   0.6991};
         vsip_scalar_d rdta0[32] = { 0.7182,    0.2285,   -0.0999,   -0.0320,
         ...
         vsip_scalar_d idta0[32] = { 0.5962,   -0.0384,   -0.1030,   -0.1778,
         ...
         fft = vsip_ccfftmip_create_d(8,4,1.0/4.0,VSIP_FFT_INV,VSIP_ROW,0,VSIP_ALG_SPACE);
         A = vsip_cmbind_d(block,4,2,8,17,4);
         B = vsip_cmcreate_d(8,4,VSIP_ROW,VSIP_MEM_NONE);
         vsip_cmcopyfrom_user_d(rdta,idta,VSIP_ROW,A);
         vsip_cmcopyfrom_user_d(rdta0,idta0,VSIP_ROW,B);
