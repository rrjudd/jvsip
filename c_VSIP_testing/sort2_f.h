...
**********************************************************************/
/* $Id: sort2_f.h,v 1.1 2008/09/19 21:01:49 judd Exp $ */

static void sort2_f(void){
   printf("********\nTEST sort (2) for float\n");
   {
      ...
      vsip_vsortip_f(s, VSIP_SORT_BYVALUE, VSIP_SORT_DESCENDING,VSIP_TRUE, vi);
