...
**********************************************************************/
/* $Id: mmin_f.h,v 2.0 2003/02/22 15:23:25 judd Exp $ */
static void mmin_f(void){
   printf("\n*******\nTEST mmin_f\n\n");
   { vsip_scalar_f data1[] = {-1, 2, 0, -5, -6,  3.4, -3.4, 5.6, -.3};
     vsip_scalar_f data2[] = {-2, 1, 0, -3, -7, -3.4, -3.5, 5.6, -.2};
     vsip_scalar_f ans[]   = {-2, 1, 0, -5, -7, -3.4, -3.5, 5.6, -.3};
     ...
     printf("check mmin_f b,c inplace\n");
     vsip_mmin_f(a,b,b);
