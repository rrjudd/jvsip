...
**********************************************************************/
/* $Id: cmmul_f.h,v 2.0 2003/02/22 15:23:21 judd Exp $ */
static void cmmul_f(void){
    printf("\n******\nTEST cmmul_f\n");
    {
        ...
        vsip_scalar_f ans_r[] =  { 1.21, 7.92, 25.41, 9.02, 25.85, 56.32, 25.74, 46.86, 79.20};
        vsip_scalar_f ans_i[] =  { -0.99, 9.68, -20.79, 8.58, -29.15, 49.28, -20.46, 58.74, -99.00};
        ...
        printf("call vsip_cmmul_f(a,b,c)\n");
        printf("a =\n");VU_cmprintm_f("8.6",m1);
        printf("b =\n");VU_cmprintm_f("8.6",m2);
        vsip_cmmul_f(m1,m2,m3);
